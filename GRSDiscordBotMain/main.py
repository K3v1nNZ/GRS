...
@client.command()
async def send_embed(ctx: discord.ApplicationContext, title: discord.Option(str, "The title of the embed", required=True), description: discord.Option(str, "The description of the embed", required=True)):
